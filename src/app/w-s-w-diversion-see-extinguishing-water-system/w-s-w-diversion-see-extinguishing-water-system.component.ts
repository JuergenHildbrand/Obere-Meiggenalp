...
@Component({
  selector: 'app-w-s-w-diversion-see-extinguishing-water-system',
  templateUrl: './w-s-w-diversion-see-extinguishing-water-system.component.html',
  styleUrls: ['./w-s-w-diversion-see-extinguishing-water-system.component.scss']
})
export class WSWDiversionSeeExtinguishingWaterSystemComponent implements OnInit {
